...
<center>
    <div class="wrapper">
    <form action="updateAgent.html" method="post" class="form-signin">       
      ...
      <table>
      	<tr>
      		<td><input type="email" class="form-control" value="<%out.println(se.getAttribute("key"));%>" name="email" placeholder="Email Address" readonly="readonly" required="" autofocus="" /></td>
      		<td> <input type="password" class="form-control" name="pass"value="<%out.println(se.getAttribute("pass"));%>" placeholder="Password" required=""/> </td>
      	</tr>
      	<tr>   
      		<td> <input placeholder="Name" class="form-control"value="<%out.println(se.getAttribute("name"));%>" name="name" type="text" required=""></td>
      		<td> <input placeholder="mobile" class="form-control"value="<%out.println(se.getAttribute("mobile"));%>" name="mobile" type="text" required=""></td>
      	</tr>
