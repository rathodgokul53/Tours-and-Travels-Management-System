...
<table id="myTable">
 ...
 <tr class="header">
    ...
    <th style="width:40%;">Date of Departure</th>
...
String s1=ses2.getAttribute("size").toString();
...
%>
 ...
 <tr>
    <td><%out.println(ses2.getAttribute("fname"+j));%></td>
    <td><%out.println(ses2.getAttribute("lname"+j));%></td>
    <td><%out.println(ses2.getAttribute("uemail"+j));%></td>
    <td><%out.println(ses2.getAttribute("tname"+j));%></td>
    <td><%out.println(ses2.getAttribute("dod"+j));%></td>
    <td><%out.println(ses2.getAttribute("nop"+j));%></td>
    <td><%out.println(ses2.getAttribute("contact"+j));%></td>
        <td><%out.println(ses2.getAttribute("bill"+j));%></td>
